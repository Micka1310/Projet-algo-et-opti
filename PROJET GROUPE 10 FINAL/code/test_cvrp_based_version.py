...
path_file_instance_vrplib = 'code/tests/data/B-n31-k5.vrp'
...
import matplotlib.pyplot as plt
import numpy as np
from alns_cvrp import ALNS_CVRP
import sys
...
print("="*60)
print("CVRP avec optimisation ALNS")
print("="*60)
...
# Créer l'instance ALNS
alns = ALNS_CVRP(instance_vrplib, initial_solution)
...
path_file_solution_vrplib = 'code/tests/data/B-n31-k5.sol'
...
alns.plot_convergence('convergence_cvrp_alns.png')
...
plt.title(f"Solution optimisée ALNS - {instance_vrplib['name']}\nCoût: {results['best_cost']:.2f} | Gap: {gap:.2f}%")
plt.xlabel("Coordonnée X")
plt.ylabel("Coordonnée Y")
plt.legend()
plt.axis('equal')
plt.savefig('solution_cvrp_alns.png', dpi=300, bbox_inches='tight')
plt.show()
...
improvements = [(initial_cost - cost) / initial_cost * 100 for cost in alns.best_cost_history]
...
plt.tight_layout()
plt.savefig('performance_cvrp_alns.png', dpi=300, bbox_inches='tight')
plt.show()

print("\nGraphiques sauvegardés:")
print("  - convergence_cvrp_alns.png")
print("  - solution_cvrp_alns.png")
print("  - performance_cvrp_alns.png")
